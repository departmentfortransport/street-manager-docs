...
![authorise]({{site.baseurl}}/api-documentation/images/v2/authorise.png)
...
![available authorisations]({{site.baseurl}}/api-documentation/images/v2/available-authorisations.png)
