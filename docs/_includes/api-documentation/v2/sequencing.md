...
![permit create and assess diagram]({{site.baseurl}}/api-documentation/images/v2/create-and-assess-permits.png)
...
![permit modification request diagram]({{site.baseurl}}/api-documentation/images/v2/permit-modification-request.png)
...
![Inspections sequence diagram]({{site.baseurl}}/api-documentation/images/v2/inspections-wsd.png)
...
![FPN sequence diagram]({{site.baseurl}}/api-documentation/images/v2/fpn-wsd.png)
...
![Reinstatement sequence diagram]({{site.baseurl}}/api-documentation/images/v2/create-reinstatement-sites.png)
