...
<ul class="govuk-list govuk-list--number">
  ...
  <li><a class="govuk-link" href="{{ site.baseurl }}/api-documentation/V2.10.8/changelog">Versions and Changes</a></li>
</ul>
...
{: .govuk-heading-s}
##### Inspection Outcomes CSV
{: .govuk-heading-s}

<code>POST /performance-reporting/inspection-outcomes/csv</code>

Retrieves a CSV containing the number of inspections grouped by type, category and outcome which are associated with the authenticated user's organisation.
{: .govuk-body}

CSVs generated by HA admin users contain inspections grouped by promoter organisation. CSVs generated by promoter admin users contain inspections grouped by HA organisation.
{: .govuk-body}
