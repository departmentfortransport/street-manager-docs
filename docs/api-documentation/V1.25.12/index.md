...
<ul class="govuk-list govuk-list--number">
  ...
  <li><a class="govuk-link" href="{{ site.baseurl }}/api-documentation/V1.25.12/changelog">Versions and Changes</a></li>
</ul>
...
<ol class="govuk-list govuk-list--bullet">
  ...
  <li><a href="/street-manager-docs/registration/">Registration</a>, for details on how to start using Street Manager with-in your organisation</li>
</ol>
