...
![sequence diagram]({{site.baseurl}}/api-documentation/images/v3/sequence-calls-used-to-submit-and-respond-to-a-permit-application.png)
...
<ol class="govuk-list govuk-list--bullet">
  ...
  <li><strong>Sites</strong>: Any reinstatement sites that have been added to the works (none initially). This is restricted to the latest 50 sites recorded against the work.  The full list can be retrieved using the <code>GET /reinstatements</code> endpoint on Reporting API.</li>
  <li><strong>Inspections</strong>: Any inspections that have been issued on the works (none initially). This is restricted to the latest 50 inspections recorded against the work.  The full list can be retrieved using the <code>GET /inspections</code> endpoint on Reporting API.</li>
...
![permit create and assess diagram]({{site.baseurl}}/api-documentation/images/v3/create-and-assess-permits.png)
...
![permit modification request diagram]({{site.baseurl}}/api-documentation/images/v3/permit-modification-request.png)
...
![Inspections sequence diagram]({{site.baseurl}}/api-documentation/images/v3/inspections-wsd.png)
...
![FPN sequence diagram]({{site.baseurl}}/api-documentation/images/v3/fpn-wsd.png)
...
![Reinstatement sequence diagram]({{site.baseurl}}/api-documentation/images/v3/create-reinstatement-sites.png)
...
![alteration sequence diagram]({{site.baseurl}}/api-documentation/images/v3/create-and-assess-permit-alteration.png)
...
![sample inspections sequence diagram]({{site.baseurl}}/api-documentation/images/v3/generating-sample-inspections.png)
