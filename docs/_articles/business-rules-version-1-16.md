...
| Modified permit | Promoter | PA in status 'Modification Request' | No |

* For promoter imposed, HA imposed and modified permit change types, the changes made will be applied automatically to the PA with the change request record available to see what has changed historically, and these change request types are not chargeable.
