...
{: .govuk-heading-m}
If you would like to stop recieving Open Data Streaming notifications, pelase raise a request using the [service desk](https://streetmanager.atlassian.net/servicedesk/customer/portal/1).
{: .govuk-body}
