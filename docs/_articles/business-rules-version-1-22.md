---
layout: article
title: Business rules - version 1.22
date: 2020-05-25T10:13:44.764Z
type: article
published: 'true'
status: publish
---
...
<span class="govuk-body-l" style="float:left">Version 1.22 (Due for release to sandbox 28/05/20)</span>
...
| ---------------------------------- | -------------------------------------------------------- |
| 4.6. Cancelling change requests | Updated to add that change requests awaiting assessment will be automatically cancelled when the permit is cancelled and/or closed |
